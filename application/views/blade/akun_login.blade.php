...
@section('header')
    @php
        $head[] = assets_url . "app-assets/css/plugins/forms/validation/form-validation.css";
    @endphp
...
@section('footer')
    @php
        $foot[] = assets_url . "app-assets/vendors/js/forms/validation/jqBootstrapValidation.js";
        $foot[] = assets_url . "app-assets/js/scripts/forms/validation/form-validation.js";
    @endphp
