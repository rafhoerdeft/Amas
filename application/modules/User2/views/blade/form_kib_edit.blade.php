                                                ...
                                                <table id="dataTable"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="{{($val->cek==1)?'row_cek':''}}">
                                                            ...
                                                            <td width="170"><?= ($val->cek==1)?"<textarea id='nama_".$val->id_barang."' name='nama_barang' rows='1' style='width: 100%;'>".$val->nama_barang."</textarea>":$val->nama_barang?></td>
                                                            <td width="110"><?= ($val->cek==1)?"<textarea id='merk_".$val->id_barang."' name='merk_barang' rows='1' style='width: 100%;'>".$val->merk_barang."</textarea>":$val->merk_barang?></td>
