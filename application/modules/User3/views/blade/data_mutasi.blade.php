        ...
        <div class="content-wrapper">
            <div class="content-header row">
                ...
                <div class="content-header-left col-md-10 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">Mutasi Aset</h3>
                            ...
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="<?= base_url($this->controller.'/dataMutasi') ?>" class="row" method="POST">
                                            <?= token_csrf() ?>
                                        ...
                                        <table id="dataTable" class="table table-hover table-bordered table-striped table-responsive d-xl-table"
                                            ...
                                            <tbody>
                                                <?php $no=1; foreach ($dataMutasi as $val) { ?>
                                                    <tr>
    ...
    <div class="modal animated bounceInDown text-left" id="modal_form" role="dialog" aria-labelledby="myModalLabel10" aria-hidden="true">
        <div class="modal-dialog" role="document">
            ...
            <form name="form_input" id="form_input" method="post" action="">
                ...
                <input type="hidden" name="back" id="back" value="<?= base_url($this->controller.'/dataMutasi'.($selectJenis!=''?'/'.encode($selectJenis):'')) ?>">
...
@section('footer')
    @php
        ...
        // $foot[] = base_url('assets/js/cetak_excel.js');
